...
class my_NN01:
    ...
    def train(self, input_data, target_data):
        ...
        w1_decrease_amount_with_jit = self.learning_rate * feed_forward_utils.feed_forward_partial_W1(input_data, target_data,self.W1, self.W2, self.B1, self.B2)

        print('w1 편미분 차감값:', w1_decrease_amount_with_jit)

        self.W1 -= w1_decrease_amount_with_jit / 100
